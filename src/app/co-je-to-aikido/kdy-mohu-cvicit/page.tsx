...
export default function KdyMohuCvicit() {
  return (
    <>
      <PageHeader title="Kdy mohu a nemohu cvičit aikidó" />
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg text-gray-700 max-w-none">
          <h2>Věkové hranice</h2>
          <p>
          ...
          <h2>Zdravotní omezení</h2>
          <div className="bg-red-50 border-l-4 border-red-400 p-4 my-6 not-prose rounded-r-lg">
